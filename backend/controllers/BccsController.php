...
use backend\models\EnterpriseFileBccsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * BccsController implements the CRUD actions for EnterpriseFile model.
 */
class BccsController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new EnterpriseFileBccsSearch();
