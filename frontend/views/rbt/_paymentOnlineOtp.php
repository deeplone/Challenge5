...
<?php $form = ActiveForm::begin(['action' => Url::toRoute(['/rbt/payment-online-confirm-2', 'relate-id' => Yii::$app->request->queryParams['relate-id']]),
    ...
    <div class="txt-line">
        ...
        Số tiền cần thanh toán là <span class="txt-color"><?= number_format($fee); ?> VNĐ</span>
    </div>
...
<?= Html::hiddenInput('id', $id) ?>
    ...
    <div class="form-group">
        <p><a onclick="clearErrorMsg()" href="javascript:resendOtp('/user/resend-otp','<?= $msisdn ?>')">Lấy lại mã xác thực OTP</a></p>
    </div>
