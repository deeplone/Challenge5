...
<?php $form = ActiveForm::begin(['action' => Url::toRoute(['/rbt/payment-request-confirm-2', 'relate-id' => Yii::$app->request->queryParams['relate-id']]),
    ...
    <div class="txt-line">
        ...
        Số tiền cần thanh toán là <span
                class="txt-color"><?= number_format($fee1 + $fee2); ?> VNĐ</span>
    </div>
