...
class Generator extends \yii\gii\Generator {
    ...
    public function generate() {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $files[] = new CodeFile(
                    Yii::getAlias('@common') . '/models/db/' . $modelClassName . 'DB.php', $this->render('model.php', $params)
            );
            $files[] = new CodeFile(
                    Yii::getAlias('@common') . '/models/' . $modelClassName . 'Base.php', $this->render('base.php', $params)
            );
            $files[] = new CodeFile(
                    Yii::getAlias('@backend') . '/models/' . $modelClassName . '.php', $this->render('backend.php', $params)
            );
            $files[] = new CodeFile(
                    Yii::getAlias('@frontend') . '/models/' . $modelClassName . '.php', $this->render('frontend.php', $params)
            );
            $files[] = new CodeFile(
                    Yii::getAlias('@api') . '/models/' . $modelClassName . '.php', $this->render('api.php', $params)
            );
            // query :
            if ($queryClassName) {
